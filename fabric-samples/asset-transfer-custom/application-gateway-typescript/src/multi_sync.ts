/**
 * multi_sync : Processes each file by turn, splits a file with constant ratio
 * Script does WAIT until the file upload completes before processing next file ->> ordered
 *
 * This node app takes 3 parameters (e.g. npm run multi-async 10 20 50)
...
const resultsFileName = 'results_' + getDateTimeString(new Date(Date.now())) + '_multi_sync.csv';
